        ...
        <nav class="tyn-appbar">
            <div class="tyn-appbar-wrap">
                <div class="tyn-appbar-logo">
                    <a class="tyn-logo" href="index-2.html">
                ...
                <div class="tyn-appbar-content">
                    <ul class="tyn-appbar-nav tyn-appbar-nav-start">
                        <li class="tyn-appbar-item">
                            <a class="tyn-appbar-link" href="index-2.html">
                        ...
                        <div class="tab-pane show active" id="all-chats" tabindex="0" role="tabpanel">
                            <ul class="tyn-aside-list">
                                ...
                                <li class="tyn-aside-item js-toggle-main">
                                    <div class="tyn-media-group">
                                        <div class="tyn-media tyn-size-lg">
                                            <img src="{{ asset('images') }}/avatar/8.jpg" alt="">
                                        </div><!-- .tyn-media -->
                                        <div class="tyn-media-col">
                                            <div class="tyn-media-row">
                                ...
                                <li class="tyn-aside-item js-toggle-main">
                                    <div class="tyn-media-group">
                                        <div class="tyn-media tyn-size-lg">
                                            <img src="{{ asset('images') }}/avatar/11.jpg" alt="">
                                        </div><!-- .tyn-media -->
                                        <div class="tyn-media-col">
                                            <div class="tyn-media-row">
                    ...
                    <div class="tyn-reply" id="tynReply">
                                ...
                                <div class="tyn-reply-bubble">
                                    <div class="tyn-reply-media">
                                        <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8" class="glightbox tyn-video" data-gallery="media-video">
                                            <img src="{{ asset('images') }}/gallery/video/hr-6.jpg" class="tyn-image" alt="">
                        ...
                        <div class="tyn-reply-item incoming">
                            ...
                            <div class="tyn-reply-group">
                                <div class="tyn-reply-bubble">
                                    <div class="tyn-reply-media">
                                        <a href="{{ asset('images') }}/gallery/chat/1.jpg" class="glightbox tyn-thumb" data-gallery="media-photo">
                                            <img src="{{ asset('images') }}/gallery/chat/thumb-1.jpg" class="tyn-image" alt="">
                                        </a>
                                        <a href="{{ asset('images') }}/gallery/chat/2.jpg" class="glightbox tyn-thumb" data-gallery="media-photo">
                                            <img src="{{ asset('images') }}/gallery/chat/thumb-2.jpg" class="tyn-image" alt="">
                                        </a>
                                        <a href="{{ asset('images') }}/gallery/chat/3.jpg" class="glightbox tyn-thumb" data-gallery="media-photo">
                                            <img src="{{ asset('images') }}/gallery/chat/thumb-3.jpg" class="tyn-image" alt="">
                                        </a>
                                        <a href="{{ asset('images') }}/gallery/chat/4.jpg" class="glightbox tyn-thumb" data-gallery="media-photo">
                                            <img src="{{ asset('images') }}/gallery/chat/thumb-4.jpg" class="tyn-image" alt="">
                                        </a>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane show active" id="chat-media-images" tabindex="0">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-4">
                                                <a href="{{ asset('images') }}/gallery/chat/6.jpg" class="glightbox tyn-thumb" data-gallery="media-photo">
                                                    <img src="{{ asset('images') }}/gallery/chat/thumb-6.jpg" class="tyn-image" alt="">
                                                </a>
                                            </div><!-- .col -->
                                        </div><!-- .row -->
                                    </div><!-- .tab-pane -->
                                    <div class="tab-pane" id="chat-media-videos" tabindex="0">
                                        <div class="row g-3">
                                            <div class="col-6">
                                                <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8" class="glightbox tyn-video" data-gallery="media-video">
                                                    <img src="{{ asset('images') }}/gallery/video/hr-1.jpg" class="tyn-image" alt="">
                                                    <div class="tyn-video-icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                                            <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393" />
                                                        </svg><!-- play-fill -->
                                            ...
                                            <div class="col-6">
                                                <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8" class="glightbox tyn-video" data-gallery="media-video">
                                                    <img src="{{ asset('images') }}/gallery/video/hr-2.jpg" class="tyn-image" alt="">
                                                    <div class="tyn-video-icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                                            <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393" />
                                                        </svg><!-- play-fill -->
                                            ...
                                            <div class="col-6">
                                                <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8" class="glightbox tyn-video" data-gallery="media-video">
                                                    <img src="{{ asset('images') }}/gallery/video/hr-3.jpg" class="tyn-image" alt="">
                                                    <div class="tyn-video-icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                                            <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393" />
                                                        </svg><!-- play-fill -->
                                            ...
                                            <div class="col-6">
                                                <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8" class="glightbox tyn-video" data-gallery="media-video">
                                                    <img src="{{ asset('images') }}/gallery/video/hr-4.jpg" class="tyn-image" alt="">
                                                    <div class="tyn-video-icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                                            <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393" />
                                                        </svg><!-- play-fill -->
                                            ...
                                            <div class="col-6">
                                                <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8" class="glightbox tyn-video" data-gallery="media-video">
                                                    <img src="{{ asset('images') }}/gallery/video/vr-5.jpg" class="tyn-image" alt="">
                                                    <div class="tyn-video-icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                                            <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393" />
                                                        </svg><!-- play-fill -->
                                        ...
                                        <ul class="tyn-media-list gap gap-3">
                                                ...
                                                <a href="#" class="tyn-links">
                                                    <div class="tyn-media-group">
                                                        <div class="tyn-media tyn-size-xl">
                                                            <img src="{{ asset('images') }}/gallery/chat/thumb-7.jpg" alt="">
                                                        </div>
                                                        <div class="tyn-media-col">
                                            ...
                                            <li>
                                                <a href="#" class="tyn-links">
                                                    <div class="tyn-media-group">
                                                        <div class="tyn-media tyn-size-xl">
                                                            <img src="{{ asset('images') }}/gallery/chat/thumb-8.jpg" alt="">
                                                        </div>
                                                        <div class="tyn-media-col">
                ...
                <div class="tyn-chat-call tyn-chat-call-video">
                    <div class="tyn-chat-call-stack">
                        <div class="tyn-chat-call-cover">
                            <img src="{{ asset('images') }}/v-cover/1.jpg" alt="">
                        </div>
                    ...
                    <div class="tyn-chat-call-stack on-dark">
                        <div class="tyn-media-group p-4">
                            ...
                            <div class="tyn-media tyn-media-1x1_3 tyn-size-3xl border border-2 border-dark">
                                <img src="{{ asset('images') }}/v-cover/2.jpg" alt="">
                            </div><!-- .tyn-media -->
                        </div><!-- .tyn-media-group -->
